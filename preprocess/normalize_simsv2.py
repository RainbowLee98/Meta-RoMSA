...
sims_path = os.path.join(data_root, 'SIMSV2/Processed/unaligned.pkl')
...
# for split in ['train', 'valid', 'test','query']:
    # audio
...
# save
sims_path_normalized = os.path.join(data_root, 'SIMSV2/Processed/unaligned_normalized.pkl')
